    ...
    return (
        <div>
            <div className="d-flex flex-column flex-md-row align-content-center flex-wrap justify-content-md-around mx-5">
                <Project nome="Paragon Traveller" imagem="paragon_traveller.png" tool_1="csharp.png" tool_2="unity.png" descricao="Meu primeiro jogo feito na Unity, O jogador terá de sobreviver contra hordas de inimigos e enfrentar chefões poderosos, indo cada vez mais longe e ganhando mais pontos."/> 
                <Project nome="Hiper Racer" imagem="hiper_racer.png" tool_1="python.png" descricao="O jogador deve-se desviar de carros que aparecem na pista e coletar moedas, e evitar moedas vermelhas para evitar de perder ponto."/> 
            </div>
            <div className="d-flex flex-column flex-md-row align-content-center flex-wrap justify-content-md-around mx-5">
