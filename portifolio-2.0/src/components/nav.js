...
function nav(){
    return(
        <Header className="row pb-5 d-flex align-items-center">
            ...
            <a className="col-1 text-end text-decoration-none fs-5 p-0" href="#"><i className="bi bi-house"></i>Home</a>
            <a className="col-1 mx-5 text-decoration-none fs-5 p-0" href="#"><i className="bi bi-tools p-0"></i>Projetos</a>
